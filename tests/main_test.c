...
extern void TestRaft_membership_add_node_with_is_self_sets_my_node(CuTest*);
extern void TestRaft_membership_remove_then_readd_same_id(CuTest*);
extern void TestRaft_membership_entry_is_cfg_change_for_all_types(CuTest*);
extern void TestRaft_membership_entry_is_voting_cfg_change(CuTest*);
extern void TestRaft_membership_voting_change_is_in_progress(CuTest*);
extern void TestRaft_membership_one_voting_change_only_guard(CuTest*);
extern void TestRaft_membership_notify_membership_event_fires(CuTest*);
extern void TestRaft_membership_cfg_change_committed_via_ae_response(CuTest*);
extern void TestRaft_membership_demote_node_becomes_non_voting(CuTest*);
extern void TestRaft_membership_remove_node_via_committed_entry(CuTest*);
extern void TestRaft_memory_free_after_basic_setup(CuTest*);
extern void TestRaft_memory_free_after_nodes_and_entries(CuTest*);
extern void TestRaft_memory_clear_resets_state_and_reusable(CuTest*);
extern void TestRaft_memory_clear_then_readd_nodes(CuTest*);
extern void TestRaft_memory_custom_heap_functions(CuTest*);
extern void TestRaft_memory_custom_heap_malloc_null_returns_nomem(CuTest*);
extern void TestRaft_misc_entry_response_committed_returns_0_for_uncommitted(CuTest*);
extern void TestRaft_misc_entry_response_committed_returns_neg1_for_invalidated(CuTest*);
extern void TestRaft_misc_vote_and_get_voted_for_round_trip(CuTest*);
extern void TestRaft_misc_vote_for_nodeid_round_trip(CuTest*);
extern void TestRaft_misc_set_commit_idx_get_commit_idx_round_trip(CuTest*);
extern void TestRaft_misc_become_leader_sets_state(CuTest*);
extern void TestRaft_misc_become_follower_from_leader(CuTest*);
extern void TestRaft_misc_get_entry_from_idx_returns_null_for_invalid(CuTest*);
extern void TestRaft_misc_get_entry_from_idx_returns_correct_entry(CuTest*);
extern void TestRaft_misc_get_node_returns_null_for_unknown_id(CuTest*);
extern void TestRaft_misc_get_node_from_idx_returns_correct_node(CuTest*);
extern void TestRaft_misc_poll_entry_returns_oldest_and_removes(CuTest*);
extern void TestRaft_membership_add_node_committed_sets_flags(CuTest*);
...
int RunAllTests(void)
{
    ...
    SUITE_ADD_TEST(suite, TestRaft_membership_add_node_with_is_self_sets_my_node);
    SUITE_ADD_TEST(suite, TestRaft_membership_remove_then_readd_same_id);
    SUITE_ADD_TEST(suite, TestRaft_membership_entry_is_cfg_change_for_all_types);
    SUITE_ADD_TEST(suite, TestRaft_membership_entry_is_voting_cfg_change);
    SUITE_ADD_TEST(suite, TestRaft_membership_voting_change_is_in_progress);
    SUITE_ADD_TEST(suite, TestRaft_membership_one_voting_change_only_guard);
    SUITE_ADD_TEST(suite, TestRaft_membership_notify_membership_event_fires);
    SUITE_ADD_TEST(suite, TestRaft_membership_cfg_change_committed_via_ae_response);
    SUITE_ADD_TEST(suite, TestRaft_membership_demote_node_becomes_non_voting);
    SUITE_ADD_TEST(suite, TestRaft_membership_remove_node_via_committed_entry);
    SUITE_ADD_TEST(suite, TestRaft_memory_free_after_basic_setup);
    SUITE_ADD_TEST(suite, TestRaft_memory_free_after_nodes_and_entries);
    SUITE_ADD_TEST(suite, TestRaft_memory_clear_resets_state_and_reusable);
    SUITE_ADD_TEST(suite, TestRaft_memory_clear_then_readd_nodes);
    SUITE_ADD_TEST(suite, TestRaft_memory_custom_heap_functions);
    SUITE_ADD_TEST(suite, TestRaft_memory_custom_heap_malloc_null_returns_nomem);
    SUITE_ADD_TEST(suite, TestRaft_misc_entry_response_committed_returns_0_for_uncommitted);
    SUITE_ADD_TEST(suite, TestRaft_misc_entry_response_committed_returns_neg1_for_invalidated);
    SUITE_ADD_TEST(suite, TestRaft_misc_vote_and_get_voted_for_round_trip);
    SUITE_ADD_TEST(suite, TestRaft_misc_vote_for_nodeid_round_trip);
    SUITE_ADD_TEST(suite, TestRaft_misc_set_commit_idx_get_commit_idx_round_trip);
    SUITE_ADD_TEST(suite, TestRaft_misc_become_leader_sets_state);
    SUITE_ADD_TEST(suite, TestRaft_misc_become_follower_from_leader);
    SUITE_ADD_TEST(suite, TestRaft_misc_get_entry_from_idx_returns_null_for_invalid);
    SUITE_ADD_TEST(suite, TestRaft_misc_get_entry_from_idx_returns_correct_entry);
    SUITE_ADD_TEST(suite, TestRaft_misc_get_node_returns_null_for_unknown_id);
    SUITE_ADD_TEST(suite, TestRaft_misc_get_node_from_idx_returns_correct_node);
    SUITE_ADD_TEST(suite, TestRaft_misc_poll_entry_returns_oldest_and_removes);
    SUITE_ADD_TEST(suite, TestRaft_membership_add_node_committed_sets_flags);
